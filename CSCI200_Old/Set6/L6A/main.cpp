/* CSCI 200: Lab 6A: Create Array and LinkedList classes
 *
 * Author: Evan Ernst
 *
 * Using inheretance from the main list template class, implement array and linked list classes with member functions for modifying or accessing elements
 */
